...
proc newMTL4CommandQueue*(
  device: MTLDevice
): MTL4CommandQueue {.objc: "newMTL4CommandQueue".}

proc newMTL4CommandQueueWithDescriptor*(
  device: MTLDevice, descriptor: MTL4CommandQueueDescriptor, error: ptr NSError
): MTL4CommandQueue {.objc: "newMTL4CommandQueueWithDescriptor:error:".}

proc newCommandBuffer*(
  device: MTLDevice
): MTL4CommandBuffer {.objc: "newCommandBuffer".}

proc newCommandAllocatorWithDescriptor*(
  device: MTLDevice, descriptor: MTL4CommandAllocatorDescriptor, error: ptr NSError
): MTL4CommandAllocator {.objc: "newCommandAllocatorWithDescriptor:error:".}

proc newArgumentTableWithDescriptor*(
  device: MTLDevice, descriptor: MTL4ArgumentTableDescriptor, error: ptr NSError
): MTL4ArgumentTable {.objc: "newArgumentTableWithDescriptor:error:".}

proc newCompilerWithDescriptor*(
  device: MTLDevice, descriptor: MTL4CompilerDescriptor, error: ptr NSError
...
proc feedbackQueue*(
  d: MTL4CommandQueueDescriptor
): DispatchQueue {.objc: "feedbackQueue".}

proc setFeedbackQueue*(
  d: MTL4CommandQueueDescriptor, queue: DispatchQueue
) {.objc: "setFeedbackQueue:".}
...
proc commit*(
  q: MTL4CommandQueue, commandBuffers: ptr MTL4CommandBuffer, count: NSUInteger
) {.objc: "commit:count:".}
...
proc setRenderPipelineState*(
  e: MTL4RenderCommandEncoder, state: MTLRenderPipelineState
) {.objc: "setRenderPipelineState:".}

proc setVertexBuffer*(
  e: MTL4RenderCommandEncoder, buffer: MTLBuffer, offset: NSUInteger, index: NSUInteger
...
proc colorAttachments*(
  d: MTL4RenderPassDescriptor
): MTLRenderPassColorAttachmentDescriptorArray {.objc: "colorAttachments".}

proc depthAttachment*(
  d: MTL4RenderPassDescriptor
): MTLRenderPassDepthAttachmentDescriptor {.objc: "depthAttachment".}

proc stencilAttachment*(
  d: MTL4RenderPassDescriptor
): MTLRenderPassStencilAttachmentDescriptor {.objc: "stencilAttachment".}

proc renderTargetWidth*(
  d: MTL4RenderPassDescriptor
): NSUInteger {.objc: "renderTargetWidth".}

proc setRenderTargetWidth*(
  d: MTL4RenderPassDescriptor, width: NSUInteger
) {.objc: "setRenderTargetWidth:".}

proc renderTargetHeight*(
  d: MTL4RenderPassDescriptor
): NSUInteger {.objc: "renderTargetHeight".}

proc setRenderTargetHeight*(
  d: MTL4RenderPassDescriptor, height: NSUInteger
) {.objc: "setRenderTargetHeight:".}

proc defaultRasterSampleCount*(
  d: MTL4RenderPassDescriptor
): NSUInteger {.objc: "defaultRasterSampleCount".}

proc setDefaultRasterSampleCount*(
  d: MTL4RenderPassDescriptor, count: NSUInteger
) {.objc: "setDefaultRasterSampleCount:".}
...
proc setOptions*(
  d: MTL4LibraryDescriptor, options: MTLCompileOptions
) {.objc: "setOptions:".}
...
proc setLibrary*(
  d: MTL4LibraryFunctionDescriptor, library: MTLLibrary
) {.objc: "setLibrary:".}

proc functionDescriptor*(
  d: MTL4SpecializedFunctionDescriptor
): MTL4FunctionDescriptor {.objc: "functionDescriptor".}

proc setFunctionDescriptor*(
  d: MTL4SpecializedFunctionDescriptor, descriptor: MTL4FunctionDescriptor
) {.objc: "setFunctionDescriptor:".}

proc specializedName*(
  d: MTL4SpecializedFunctionDescriptor
): NSString {.objc: "specializedName".}

proc setSpecializedName*(
  d: MTL4SpecializedFunctionDescriptor, name: NSString
) {.objc: "setSpecializedName:".}

proc constantValues*(
  d: MTL4SpecializedFunctionDescriptor
): MTLFunctionConstantValues {.objc: "constantValues".}

proc setConstantValues*(
  d: MTL4SpecializedFunctionDescriptor, values: MTLFunctionConstantValues
) {.objc: "setConstantValues:".}

proc vertexFunctionDescriptor*(
  d: MTL4RenderPipelineDescriptor
): MTL4FunctionDescriptor {.objc: "vertexFunctionDescriptor".}

proc setVertexFunctionDescriptor*(
  d: MTL4RenderPipelineDescriptor, f: MTL4FunctionDescriptor
) {.objc: "setVertexFunctionDescriptor:".}

proc fragmentFunctionDescriptor*(
  d: MTL4RenderPipelineDescriptor
): MTL4FunctionDescriptor {.objc: "fragmentFunctionDescriptor".}

proc setFragmentFunctionDescriptor*(
  d: MTL4RenderPipelineDescriptor, f: MTL4FunctionDescriptor
) {.objc: "setFragmentFunctionDescriptor:".}
...
proc setVertexDescriptor*(
  d: MTL4RenderPipelineDescriptor, descriptor: MTLVertexDescriptor
) {.objc: "setVertexDescriptor:".}

proc colorAttachments*(
  d: MTL4RenderPipelineDescriptor
): MTL4RenderPipelineColorAttachmentDescriptorArray {.objc: "colorAttachments".}

proc inputPrimitiveTopology*(
  d: MTL4RenderPipelineDescriptor
): MTLPrimitiveTopologyClass {.objc: "inputPrimitiveTopology".}

proc setInputPrimitiveTopology*(
  d: MTL4RenderPipelineDescriptor, topology: MTLPrimitiveTopologyClass
) {.objc: "setInputPrimitiveTopology:".}

proc objectAtIndexedSubscript*(
  a: MTL4RenderPipelineColorAttachmentDescriptorArray, index: NSUInteger
...
proc pixelFormat*(
  d: MTL4RenderPipelineColorAttachmentDescriptor
): MTLPixelFormat {.objc: "pixelFormat".}

proc setPixelFormat*(
  d: MTL4RenderPipelineColorAttachmentDescriptor, format: MTLPixelFormat
) {.objc: "setPixelFormat:".}

proc blendingState*(
  d: MTL4RenderPipelineColorAttachmentDescriptor
): MTL4BlendState {.objc: "blendingState".}

proc setBlendingState*(
  d: MTL4RenderPipelineColorAttachmentDescriptor, state: MTL4BlendState
) {.objc: "setBlendingState:".}

proc writeMask*(
  d: MTL4RenderPipelineColorAttachmentDescriptor
): MTLColorWriteMask {.objc: "writeMask".}

proc setWriteMask*(
  d: MTL4RenderPipelineColorAttachmentDescriptor, mask: MTLColorWriteMask
) {.objc: "setWriteMask:".}

proc reset*(d: MTL4RenderPipelineColorAttachmentDescriptor) {.objc: "reset".}

proc newLibraryWithDescriptor*(
  c: MTL4Compiler, descriptor: MTL4LibraryDescriptor, error: ptr NSError
...
proc newRenderPipelineStateWithDescriptor*(
  ...
  objc: "newRenderPipelineStateWithDescriptor:compilerTaskOptions:error:"
.}
